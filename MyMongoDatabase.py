...
myMongoUrl = ("mongodb://klemeragm:%s:%s@cluster1-shard-00-00.laahq.mongodb.net:27017,cluster1-shard-00-01.laahq.mongodb.net:27017,cluster1-shard-00-02.laahq.mongodb.net:27017/covid19?ssl=true&replicaSet=atlas-xosvxq-shard-0&authSource=admin&retryWrites=true&w=majority") % (
